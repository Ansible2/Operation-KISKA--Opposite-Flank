...
[
	...
	[0.0,  		{	
					["Kiska_AncientBuilders"] call Kiska_fnc_PlayMusic;
...
fn_AfterBrief = {
	...
	*/
	...
	[
		{!(missionNamespace getVariable "musicPlaying")}, 
		{	
			["Kiska_Lobby",0,true] call CBA_fnc_playMusic;
		}
...
[_timeline, 0, nil, if (isServer) then {allMapMarkers}, if (isServer) then {_showMarkers}, "marker_frame_3",true,{call fn_AfterBrief;}] spawn BIS_fnc_AnimatedBriefing;  
